...
export default function TeacherCard(props) {
    ...
    return (
        <div className='w-full flex flex-col gap-3 items-center rounded-2xl bg-slate-50 border-2 border-slate-200 p-5 sticky top-24 right-0'>
            <img src="https://github.com/MohammadHoseinHassaniNassab/lebaseton/blob/main/src/assets/images/user-3296.png?raw=true" className='rounded-full w-16' alt="" />
            <Link className='font-[500] btn-outline-primary' to={'/teachers/' + teacherID}>
                <CiLogin />
                دوره های دبیر
            </Link>
            <h2 className='text-2xl font-bold'>محمد اکبری</h2>
